...
<template>
  <div class="wantbuy">
    <breadcrumb>
      <span slot="second" @click="tobuying">求购专区</span>
      > 发布求购
    </breadcrumb>
    <div class="title">
      <h1>发布求购信息</h1>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        bkid: [{ required: true, message: "请选择宠物类型", trigger: "change" }],
        skid: [{ required: true, message: "请选择宠物品种", trigger: "change" }],
        ...
        // ],
        photo: [{ validator: checkphoto, trigger: "blur" }]
      }
    };
  },
  methods: {
