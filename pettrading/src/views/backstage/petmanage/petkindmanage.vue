    ...
    <div class="bkindbar">
      ...
      <div class="bkind">
        <el-table :data="bkind" border style="width: 541px">
          <el-table-column prop="bkid" label="类型id" sortable width="180"></el-table-column>
          ...
          <el-table-column label="操作" width="180">
            <template slot-scope="scope">
              <span v-if="showbkindindex == scope.$index">
                <el-button size="mini" type="primary" @click="updatebkind(scope.$index, scope.row)">确认</el-button>
                <el-button size="mini" type="info" @click="showbkindindex = -1">取消</el-button>
              </span>
              <span v-if="showbkindindex != scope.$index">
                <el-button size="mini" @click="handleEditbkind(scope.$index, scope.row)">编辑</el-button>
                <el-popconfirm
    ...
    <div class="skindbar">
      ...
      <div class="skind">
        <el-table :data="skind" border style="width: 721px">
          <el-table-column prop="skid" label="品种id" sortable width="180"></el-table-column>
          ...
          <el-table-column label="操作" width="180">
            <template slot-scope="scope">
              <span v-if="showskindindex == scope.$index">
                <el-button size="mini" type="primary" @click="updateskind(scope.$index, scope.row)">确认</el-button>
                <el-button size="mini" type="info" @click="showskindindex = -1">取消</el-button>
              </span>
              <span v-if="showskindindex != scope.$index">
                <el-button size="mini" @click="handleEditskind(scope.$index, scope.row)">编辑</el-button>
                <el-popconfirm
                  confirmButtonText="确定"
                  cancelButtonText="取消"
                  placement="top"
