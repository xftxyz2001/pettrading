  ...
  <div class="mypetdetail">
    <div>
      ...
      <el-table :data="tableData" style="width: 100%">
        <el-table-column prop="user.username" label="下单用户" width="110"></el-table-column>
        <el-table-column prop="recipientname" label="收件人" width="110"></el-table-column>
        <el-table-column prop="phone" label="手机号" width="120"></el-table-column>
        <el-table-column prop="address" label="详细地址"></el-table-column>
        <el-table-column prop="price" width="100" label="下单时价格"></el-table-column>
        <el-table-column prop="date" width="160" label="下单时间"></el-table-column>
      ...
      <div v-if="shownew">
        ...
        <el-table :data="tableData" style="width: 100%">
          <el-table-column prop="user.username" label="下单用户" width="110"></el-table-column>
          <el-table-column prop="newrecipientname" label="收件人" width="110"></el-table-column>
          <el-table-column prop="newphone" label="手机号" width="120"></el-table-column>
          <el-table-column prop="newaddress" label="详细地址"></el-table-column>
          <el-table-column prop="price" width="100" label="下单时价格"></el-table-column>
          <el-table-column prop="date" width="160" label="下单时间"></el-table-column>
  ...
  created() {
    requestquerypetorder({
      ...
      .then(res => {
        ...
        if (
          this.tableData[0].newphone != null &&
          this.tableData[0].newphone != "" &&
          this.tableData[0].uid != this.$store.state.uid
        ) {
          this.shownew = true;
        }
